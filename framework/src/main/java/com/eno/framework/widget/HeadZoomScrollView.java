...
public class HeadZoomScrollView extends ScrollView {
    ...
    public HeadZoomScrollView(final Context context) {
        super(context);
    }

    public HeadZoomScrollView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }

    public HeadZoomScrollView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
